<template>
  <div class="item-based-cf-rs">
    <h1>Item Based Collaborative Filtering Recommender System</h1>
...
import { getItemBasedCFRSRecommendations } from '@/connectors/commonConnector';
